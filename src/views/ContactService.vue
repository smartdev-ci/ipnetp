  ...
  <main>
    <section class="form-container">
      ...
      <form @submit.prevent="handleSubmit" class="form-box">
        ...
        <div class="form-group">
          <label for="destinataire">Destinataire IPNETP</label>
          <select id="destinataire" v-model="form.destinataire" required>
            <option value="">—Veuillez choisir une option—</option>
            <option>Direction générale</option>
            <option>Agence comptable</option>
            <option>Contrôle budgétaire</option>
            <option>Direction des affaires financières</option>
            <option>Secrétariat général</option>
            <option>Ecole de formation initiale</option>
            <option>Ecole de formation continue</option>
            <option>Centre de recherche et de production</option>
          </select>
        </div>
